<?php 
  ...
  */
  abstract class BasePageAttachments extends DataManager {
    ...
    * @static
    */
    static private $columns = array('id' => DATA_TYPE_INTEGER, 'rel_object_id' => DATA_TYPE_INTEGER, 'rel_object_manager' => DATA_TYPE_STRING, 'project_id' => DATA_TYPE_INTEGER, 'page_name' => DATA_TYPE_STRING, 'text' => DATA_TYPE_STRING, 'order' => DATA_TYPE_INTEGER, 'created_on' => DATA_TYPE_DATETIME, 'created_by_id' => DATA_TYPE_INTEGER, 'updated_on' => DATA_TYPE_DATETIME, 'updated_by_id' => DATA_TYPE_INTEGER);
