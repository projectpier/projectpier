<div id="userbox">
  <?php echo lang('welcome back', clean($_userbox_contact->getDisplayName())) ?> (<a href="<?php echo get_url('access', 'logout') ?>" onclick="return confirm('<?php echo lang('confirm logout') ?>')"><?php echo lang('logout') ?></a>),
  <ul>
