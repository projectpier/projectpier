...
<div class="hint">
  ...
  <div class="content">
    ...
    <ul>
      ...
      <li><a href="<?php echo get_url('administration', 'members') ?>"><?php echo lang('members') ?></a> (<a href="<?php echo owner_company()->getAddContactUrl() ?>"><?php echo lang('add contact') ?></a>)</li>
